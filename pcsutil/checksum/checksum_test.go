...
func TestChecksum(t *testing.T) {
	...
	fmt.Println("--- /Users/syy/go/src/github.com/milin2436/BaiduPCS-Go/BaiduPCS-Go")
	for _, flag := range flagList {
		lf := checksum.NewLocalFileChecksumWithBufSize("/Users/syy/go/src/github.com/milin2436/BaiduPCS-Go/BaiduPCS-Go", checksum.DefaultBufSize-3, checksum.DefaultBufSize)
		err := lf.OpenPath()
		if err != nil {
			t.Fatal(err)
		}
